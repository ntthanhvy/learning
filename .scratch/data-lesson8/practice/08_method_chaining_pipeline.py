...
# ---------------------------------------------------------------------------
# Exercise 1 — write Lessons 3+7's cleaning as ONE chain: coerce amount to
# numeric, then drop rows missing amount or order_date. Wrap the expression
# in parentheses; use .assign(amount=lambda d: ...) for the coerce step.
clean = ...
