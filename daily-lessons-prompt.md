...
- Finish with a one-line summary per course, EXACTLY this shape in plain text (no backticks, no bold, no bullet list — automation greps this line): `go: generated 000N-… | rust: skipped (exists) | backend: … | data: … | python: …`.
